...
# 节点数
cs_node_nums= [100, 200, 300, 400, 500]
# 分片数
cs_shard_nums = [10, 15, 20, 30, 40, 50]
...
for cs_node_num in cs_node_nums:
    for cs_shard_num in cs_shard_nums:
        if cs_node_num / cs_shard_num < 4:
            break
    # 读取 params.json 配置文件。
        ...
        with open(filename, 'r') as f:
            data = json.load(f)
            data['num_nodes'] = cs_node_num
            data['num_shards'] = cs_shard_num
            data['verbose'] = 0
